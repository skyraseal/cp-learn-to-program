...
n = 9999
until n == 0
  puts "#{english_number(n)} bottles of beer on the wall, #{english_number(n)} bottles of beer! Take one down, pass it around, #{(english_number(n-1)} bottles of beer on the wall!"
  n -= 1
end
